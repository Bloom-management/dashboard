...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return identityConfigured() ? <ClerkProvider appearance={{userButton:{elements:{userButtonPopoverCard:'bloom-profile-popover',userButtonTrigger:'bloom-profile-trigger'}}}} signInUrl="/sign-in" signInFallbackRedirectUrl="/" signUpFallbackRedirectUrl="/">{content}</ClerkProvider> : content;
}
