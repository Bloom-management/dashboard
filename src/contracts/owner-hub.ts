...
export type OwnerListing = { maintenance?:MaintenanceReport[]; cityId?: string | null; cityName?: string | null; id: string; name: string; timezone: string; active: boolean; setupRequired?: boolean; bedroomCount?: number | null; bathroomCount?: number | null; supplies: OwnerSupply[]; suppliesUnavailable?: boolean; nightlyGuestRateCents: number|null; hostPayoutCents: null; currency: 'USD'; sources: OwnerSource[] };
