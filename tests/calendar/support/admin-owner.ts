...
mock.module(new URL('../../../src/server/db/rpc.ts',import.meta.url).href,{namedExports:{userRpc:async(name:string)=>{assert.equal(role,'admin');assert.equal(name,'bloom_admin_property_calendar_events');return {items:[{id:'stay',startDate:'2026-09-18',endDate:'2026-09-20',kind:'reservation',status:'active',provider:'airbnb',reviewRequired:false,guestName:'PRIVATE',cleanerName:'PRIVATE'}],nextCursor:null};}}});
